...
img = document.createElement("img");
img.setAttribute("src", "img/couple.png");
...
img = document.createElement("img");
img.setAttribute("src", "img/balloon-a.png");
div.appendChild(img);
...
img = document.createElement("img");
img.setAttribute("src", "img/balloon-b.png");
div.appendChild(img);

//create text inside draw app
div = document.createElement("div");
div.classList.add("draw__text");
div.innerHTML = "<div><small>Feliz dia dos Namorados</small></div><div>Name 1 & Name 2</div>";
app.appendChild(div);
